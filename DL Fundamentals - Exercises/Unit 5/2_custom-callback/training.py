...
class TrainValDiffCallback(Callback):
    def on_validation_epoch_end(self, trainer, pl_module):
        # print(f"{pl_module.train_acc.compute()}, {pl_module.val_acc.compute()}")
        train_val_diff.append(pl_module.train_acc.compute() - pl_module.val_acc.compute())
...
if __name__ == "__main__":
    ...
    trainer = L.Trainer(
        ...
        callbacks=[TrainValDiffCallback()],
    )
